...
function Quan3(){
		...
		$("#Header").html("<center><span> VENDOR-3 INSTRUMENT QUOTATION</span></center>");
...
<br>
 <button id="submitQuotation3" class = "btn mb-5" data-toggle="modal" data-target="#preReq" style="margin-bottom: 35px;">SUBMIT QUOTATION</button>	
`;
...
// Handle form submission
  $(document).on("click", "#submitQuotation3", function () {
	  let validRowCount = 0;
