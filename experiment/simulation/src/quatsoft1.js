...
function quatsoft1(){
		...
		$("#Header").html("<center><span>VENDOR-1 SOFTWARE QUOTATION</span></center>");
...
<br>
 <button id="submitSoft1" class = "btn" data-toggle="modal" data-target="#preReq" style="margin-bottom: 35px;">SUBMIT QUOTATION</button>	
`;
...
// Handle form submission
  $(document).on("click", "#submitSoft1", function () {
	  softflg++;
