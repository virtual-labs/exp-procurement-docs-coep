...
function quateform3(){
	...
	const vendor1QuotationItems1 = finalData.Plcvendor3?.quotationItems || [];
	...
	const vendor1QuotationItems3 = finalData.servendor3?.quotationItems || [];
	...
	$("#Header").html("<center><span>VENDOR-3 QUOTATION (TERMS AND CONDITIONS)</span></center>");
  ...
  <form  class="qut-form-wrapper" id = 'form3'>
