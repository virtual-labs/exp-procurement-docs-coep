...
function Quan2() {
	...
	$("#Header").html("<center><span>VENDOR-2 INSTRUMENT QUOTATION </span></center>");
...
<br>
 <button id="submitQuotation1" class = "btn mb-5" data-toggle="modal" data-target="#preReq">SUBMIT QUOTATION</button>	
`;
...
//<!-- 			  End Modal ProStr -->	`	;
	...
	$(document).on("click", "#submitQuotation1", function() {
		let validRowCount = 0;
