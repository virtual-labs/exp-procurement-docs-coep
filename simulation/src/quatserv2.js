...
function quatserv2(){
		...
		$("#Header").html("<center><span> VENDOR-2 SERVICE QUOTATION</span></center>");
...
<br>
 <button id="submitSer2" class = "btn" data-toggle="modal" data-target="#preReq">SUBMIT QUOTATION</button>	
`;
...
// Handle form submission
  $(document).on("click", "#submitSer2", function () {
	  servflg++;
