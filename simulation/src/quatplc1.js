...
//	$("#exampleModal").modal("hide");
	plcCnt++;
		...
		$("#Header").html("<center><span> VENDOR-1 PLC QUOTATION</span></center>");
...
<br>
 <button id="submitPlc1" class = "btn" data-toggle="modal" data-target="#preReq" style="margin-bottom: 35px;">SUBMIT QUOTATION</button>	
`;
...
// Handle form submission
  $(document).on("click", "#submitPlc1", function () {
//	  $("#preReq").modal("show");
	  plcflg++;
	    let validRowCount = 0;
