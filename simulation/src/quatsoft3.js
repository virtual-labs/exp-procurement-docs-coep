...
function quatsoft3(){
		...
		$("#Header").html("<center><span>VENDOR-3 SOFTWARE QUOTATION</span></center>");
...
<br>
 <button id="submitSoft3" class = "btn" data-toggle="modal" data-target="#preReq" style="margin-bottom: 35px;">SUBMIT QUOTATION</button>	
`;
...
// Handle form submission
  $(document).on("click", "#submitSoft3", function () {
	  softflg++;
