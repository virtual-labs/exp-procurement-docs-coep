...
function quatserv1(){
		...
		$("#Header").html("<center><span>VENDOR-1 SERVICE QUOTATION</span></center>");
...
<br>
 <button id="submitSer1" class = "btn" data-toggle="modal" data-target="#preReq" style="margin-bottom: 35px;">SUBMIT QUOTATION</button>	
`;
...
// Handle form submission
  $(document).on("click", "#submitSer1", function () {
	  servflg++;
