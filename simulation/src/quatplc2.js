...
//	$("#exampleModal").modal("hide");
		...
		$("#Header").html("<center><span> VENDOR-2 PLC QUOTATION </span></center>");
...
<br>
 <button id="submitPlc2" class = "btn" data-toggle="modal" data-target="#preReq" style="margin-bottom: 35px;" >SUBMIT QUOTATION</button>	
`;
...
// Handle form submission
  $(document).on("click", "#submitPlc2", function () {
//	  $("#preReq").modal("show");
	  plcflg++;
	    let validRowCount = 0;
